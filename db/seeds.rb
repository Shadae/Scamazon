...
users = User.create([
  ...
  {user_name: 'Test1', email: 'test@test.com', password: 'password', password_confirmation: 'password'},
  {user_name: 'Test2', email: 'test2@test.com', password: 'password', password_confirmation: 'password'}])
